...
SEXP detSEIR_create(SEXP user) {
  ...
  internal->beta_1 = 0;
  internal->initial_L_I_out = 0;
  internal->initial_R0_out = 0;
  internal->initial_S_I_out = 0;
  internal->sigma_1 = 0;
  internal->betaFX = 0;
...
SEXP detSEIR_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 32, ScalarReal(internal->initial_L_I_out));
  SET_VECTOR_ELT(contents, 33, ScalarReal(internal->initial_Ma));
  SET_VECTOR_ELT(contents, 34, ScalarReal(internal->initial_R0_out));
  SET_VECTOR_ELT(contents, 35, ScalarReal(internal->initial_Rf));
  SET_VECTOR_ELT(contents, 36, ScalarReal(internal->initial_Rj));
  SET_VECTOR_ELT(contents, 37, ScalarReal(internal->initial_Rm));
  SET_VECTOR_ELT(contents, 38, ScalarReal(internal->initial_Rn));
  SET_VECTOR_ELT(contents, 39, ScalarReal(internal->initial_S_I_out));
  SET_VECTOR_ELT(contents, 40, ScalarReal(internal->initial_Sf));
  SET_VECTOR_ELT(contents, 41, ScalarReal(internal->initial_Sj));
  SET_VECTOR_ELT(contents, 42, ScalarReal(internal->initial_Sm));
  SET_VECTOR_ELT(contents, 43, ScalarReal(internal->initial_Sn));
  SET_VECTOR_ELT(contents, 44, ScalarReal(internal->initial_timeOsc));
  SET_VECTOR_ELT(contents, 45, ScalarReal(internal->kappa));
  SET_VECTOR_ELT(contents, 46, ScalarReal(internal->kappa_Val));
  SET_VECTOR_ELT(contents, 47, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 48, ScalarReal(internal->m_Val));
  SET_VECTOR_ELT(contents, 49, ScalarReal(internal->Ma_ini));
  SET_VECTOR_ELT(contents, 50, ScalarReal(internal->mj));
  SET_VECTOR_ELT(contents, 51, ScalarReal(internal->mj_Val));
  SET_VECTOR_ELT(contents, 52, ScalarReal(internal->mu));
  SET_VECTOR_ELT(contents, 53, ScalarReal(internal->mu_Val));
  SET_VECTOR_ELT(contents, 54, ScalarReal(internal->omega_2_Val));
  SET_VECTOR_ELT(contents, 55, ScalarReal(internal->omega_m));
  SET_VECTOR_ELT(contents, 56, ScalarReal(internal->omega_m_Val));
  SET_VECTOR_ELT(contents, 57, ScalarReal(internal->phi));
  SET_VECTOR_ELT(contents, 58, ScalarReal(internal->phi_Val));
  SET_VECTOR_ELT(contents, 59, ScalarReal(internal->Phi2_val));
  SET_VECTOR_ELT(contents, 60, ScalarReal(internal->phiV));
  SET_VECTOR_ELT(contents, 61, ScalarReal(internal->R0_Val));
  SET_VECTOR_ELT(contents, 62, ScalarReal(internal->Rf_ini));
  SET_VECTOR_ELT(contents, 63, ScalarReal(internal->rho));
  SET_VECTOR_ELT(contents, 64, ScalarReal(internal->rho_Val));
  SET_VECTOR_ELT(contents, 65, ScalarReal(internal->Rj_ini));
  SET_VECTOR_ELT(contents, 66, ScalarReal(internal->Rm_ini));
  SET_VECTOR_ELT(contents, 67, ScalarReal(internal->Rn_ini));
  SET_VECTOR_ELT(contents, 68, ScalarReal(internal->s));
  SET_VECTOR_ELT(contents, 69, ScalarReal(internal->s_Val));
  SET_VECTOR_ELT(contents, 70, ScalarReal(internal->S2_val));
  SET_VECTOR_ELT(contents, 71, ScalarReal(internal->Sf_ini));
  SET_VECTOR_ELT(contents, 72, ScalarReal(internal->sigma_1));
  SET_VECTOR_ELT(contents, 73, ScalarReal(internal->sigma_2));
  SET_VECTOR_ELT(contents, 74, ScalarReal(internal->sigma_2_Val));
  SET_VECTOR_ELT(contents, 75, ScalarReal(internal->sigmaVer));
  SET_VECTOR_ELT(contents, 76, ScalarReal(internal->Sj_ini));
  SET_VECTOR_ELT(contents, 77, ScalarReal(internal->Sm_ini));
  SET_VECTOR_ELT(contents, 78, ScalarReal(internal->Sn_ini));
  SET_VECTOR_ELT(contents, 79, ScalarReal(internal->sV));
  SET_VECTOR_ELT(contents, 80, ScalarReal(internal->timeOscIni));
  SET_VECTOR_ELT(contents, 81, ScalarReal(internal->zeta_s));
  ...
  SET_STRING_ELT(nms, 32, mkChar("initial_L_I_out"));
  SET_STRING_ELT(nms, 33, mkChar("initial_Ma"));
  SET_STRING_ELT(nms, 34, mkChar("initial_R0_out"));
  SET_STRING_ELT(nms, 35, mkChar("initial_Rf"));
  SET_STRING_ELT(nms, 36, mkChar("initial_Rj"));
  SET_STRING_ELT(nms, 37, mkChar("initial_Rm"));
  SET_STRING_ELT(nms, 38, mkChar("initial_Rn"));
  SET_STRING_ELT(nms, 39, mkChar("initial_S_I_out"));
  SET_STRING_ELT(nms, 40, mkChar("initial_Sf"));
  SET_STRING_ELT(nms, 41, mkChar("initial_Sj"));
  SET_STRING_ELT(nms, 42, mkChar("initial_Sm"));
  SET_STRING_ELT(nms, 43, mkChar("initial_Sn"));
  SET_STRING_ELT(nms, 44, mkChar("initial_timeOsc"));
  SET_STRING_ELT(nms, 45, mkChar("kappa"));
  SET_STRING_ELT(nms, 46, mkChar("kappa_Val"));
  SET_STRING_ELT(nms, 47, mkChar("m"));
  SET_STRING_ELT(nms, 48, mkChar("m_Val"));
  SET_STRING_ELT(nms, 49, mkChar("Ma_ini"));
  SET_STRING_ELT(nms, 50, mkChar("mj"));
  SET_STRING_ELT(nms, 51, mkChar("mj_Val"));
  SET_STRING_ELT(nms, 52, mkChar("mu"));
  SET_STRING_ELT(nms, 53, mkChar("mu_Val"));
  SET_STRING_ELT(nms, 54, mkChar("omega_2_Val"));
  SET_STRING_ELT(nms, 55, mkChar("omega_m"));
  SET_STRING_ELT(nms, 56, mkChar("omega_m_Val"));
  SET_STRING_ELT(nms, 57, mkChar("phi"));
  SET_STRING_ELT(nms, 58, mkChar("phi_Val"));
  SET_STRING_ELT(nms, 59, mkChar("Phi2_val"));
  SET_STRING_ELT(nms, 60, mkChar("phiV"));
  SET_STRING_ELT(nms, 61, mkChar("R0_Val"));
  SET_STRING_ELT(nms, 62, mkChar("Rf_ini"));
  SET_STRING_ELT(nms, 63, mkChar("rho"));
  SET_STRING_ELT(nms, 64, mkChar("rho_Val"));
  SET_STRING_ELT(nms, 65, mkChar("Rj_ini"));
  SET_STRING_ELT(nms, 66, mkChar("Rm_ini"));
  SET_STRING_ELT(nms, 67, mkChar("Rn_ini"));
  SET_STRING_ELT(nms, 68, mkChar("s"));
  SET_STRING_ELT(nms, 69, mkChar("s_Val"));
  SET_STRING_ELT(nms, 70, mkChar("S2_val"));
  SET_STRING_ELT(nms, 71, mkChar("Sf_ini"));
  SET_STRING_ELT(nms, 72, mkChar("sigma_1"));
  SET_STRING_ELT(nms, 73, mkChar("sigma_2"));
  SET_STRING_ELT(nms, 74, mkChar("sigma_2_Val"));
  SET_STRING_ELT(nms, 75, mkChar("sigmaVer"));
  SET_STRING_ELT(nms, 76, mkChar("Sj_ini"));
  SET_STRING_ELT(nms, 77, mkChar("Sm_ini"));
  SET_STRING_ELT(nms, 78, mkChar("Sn_ini"));
  SET_STRING_ELT(nms, 79, mkChar("sV"));
  SET_STRING_ELT(nms, 80, mkChar("timeOscIni"));
  SET_STRING_ELT(nms, 81, mkChar("zeta_s"));
...
SEXP detSEIR_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(variable_length, 19, R_NilValue);
  SET_VECTOR_ELT(variable_length, 20, R_NilValue);
  ...
  SET_STRING_ELT(variable_names, 19, mkChar("L_I_out"));
  SET_STRING_ELT(variable_names, 20, mkChar("S_I_out"));
...
SEXP detSEIR_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  detSEIR_internal *internal = detSEIR_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, 21));
  ...
  state[19] = internal->initial_L_I_out;
  state[20] = internal->initial_S_I_out;
  UNPROTECT(1);
  return r_state;
}
void detSEIR_rhs(detSEIR_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  double b = 2 * internal->c * exp(-(internal->s) * pow((cos(3.1415929999999999 * timeOsc - internal->phi)), 2));
  ...
  state_next[19] = epsilon * (En + Ej + Ef + Em);
  ...
  state_next[20] = betI * (Sn + Sj + Sf + Sm);
...
SEXP stochSEIR_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 160));
  ...
  SET_VECTOR_ELT(contents, 83, ScalarReal(internal->initial_L_I_out));
  SET_VECTOR_ELT(contents, 84, ScalarReal(internal->initial_Ma));
  SET_VECTOR_ELT(contents, 85, ScalarReal(internal->initial_R0_out));
  SET_VECTOR_ELT(contents, 86, ScalarReal(internal->initial_Rf));
  SET_VECTOR_ELT(contents, 87, ScalarReal(internal->initial_Rj));
  SET_VECTOR_ELT(contents, 88, ScalarReal(internal->initial_Rm));
  SET_VECTOR_ELT(contents, 89, ScalarReal(internal->initial_Rn));
  SET_VECTOR_ELT(contents, 90, ScalarReal(internal->initial_S_I_out));
  SET_VECTOR_ELT(contents, 91, ScalarReal(internal->initial_Sf));
  SET_VECTOR_ELT(contents, 92, ScalarReal(internal->initial_Sj));
  SET_VECTOR_ELT(contents, 93, ScalarReal(internal->initial_Sm));
  SET_VECTOR_ELT(contents, 94, ScalarReal(internal->initial_Sn));
  SET_VECTOR_ELT(contents, 95, ScalarReal(internal->initial_timeOsc));
  SET_VECTOR_ELT(contents, 96, ScalarReal(internal->kappa));
  SET_VECTOR_ELT(contents, 97, ScalarReal(internal->kappa_Val));
  SET_VECTOR_ELT(contents, 98, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 99, ScalarReal(internal->m_Val));
  SET_VECTOR_ELT(contents, 100, ScalarReal(internal->Ma_ini));
  SET_VECTOR_ELT(contents, 101, ScalarReal(internal->mj));
  SET_VECTOR_ELT(contents, 102, ScalarReal(internal->mj_Val));
  SET_VECTOR_ELT(contents, 103, ScalarReal(internal->mu));
  SET_VECTOR_ELT(contents, 104, ScalarReal(internal->mu_Val));
  SET_VECTOR_ELT(contents, 105, ScalarReal(internal->n_Sf_Ef));
  SET_VECTOR_ELT(contents, 106, ScalarReal(internal->n_Sj_Ej));
  SET_VECTOR_ELT(contents, 107, ScalarReal(internal->n_Sm_Em));
  SET_VECTOR_ELT(contents, 108, ScalarReal(internal->n_Sn_En));
  SET_VECTOR_ELT(contents, 109, ScalarReal(internal->omega_2_Val));
  SET_VECTOR_ELT(contents, 110, ScalarReal(internal->omega_m));
  SET_VECTOR_ELT(contents, 111, ScalarReal(internal->omega_m_Val));
  SEXP p = PROTECT(allocVector(REALSXP, internal->dim_p));
  memcpy(REAL(p), internal->p, internal->dim_p * sizeof(double));
  SET_VECTOR_ELT(contents, 112, p);
  SET_VECTOR_ELT(contents, 113, ScalarReal(internal->P_E_R));
  SET_VECTOR_ELT(contents, 114, ScalarReal(internal->P_E_S));
  SET_VECTOR_ELT(contents, 115, ScalarReal(internal->P_I_E));
  SET_VECTOR_ELT(contents, 116, ScalarReal(internal->P_I_S));
  SET_VECTOR_ELT(contents, 117, ScalarReal(internal->P_J_A));
  SET_VECTOR_ELT(contents, 118, ScalarReal(internal->P_matWane));
  SEXP p1 = PROTECT(allocVector(REALSXP, internal->dim_p1));
  memcpy(REAL(p1), internal->p1, internal->dim_p1 * sizeof(double));
  SET_VECTOR_ELT(contents, 119, p1);
  SEXP p2 = PROTECT(allocVector(REALSXP, internal->dim_p2));
  memcpy(REAL(p2), internal->p2, internal->dim_p2 * sizeof(double));
  SET_VECTOR_ELT(contents, 120, p2);
  SEXP p3 = PROTECT(allocVector(REALSXP, internal->dim_p3));
  memcpy(REAL(p3), internal->p3, internal->dim_p3 * sizeof(double));
  SET_VECTOR_ELT(contents, 121, p3);
  SEXP p4 = PROTECT(allocVector(REALSXP, internal->dim_p4));
  memcpy(REAL(p4), internal->p4, internal->dim_p4 * sizeof(double));
  SET_VECTOR_ELT(contents, 122, p4);
  SEXP pf = PROTECT(allocVector(REALSXP, internal->dim_pf));
  memcpy(REAL(pf), internal->pf, internal->dim_pf * sizeof(double));
  SET_VECTOR_ELT(contents, 123, pf);
  SEXP pf1 = PROTECT(allocVector(REALSXP, internal->dim_pf1));
  memcpy(REAL(pf1), internal->pf1, internal->dim_pf1 * sizeof(double));
  SET_VECTOR_ELT(contents, 124, pf1);
  SEXP pf2 = PROTECT(allocVector(REALSXP, internal->dim_pf2));
  memcpy(REAL(pf2), internal->pf2, internal->dim_pf2 * sizeof(double));
  SET_VECTOR_ELT(contents, 125, pf2);
  SEXP pf3 = PROTECT(allocVector(REALSXP, internal->dim_pf3));
  memcpy(REAL(pf3), internal->pf3, internal->dim_pf3 * sizeof(double));
  SET_VECTOR_ELT(contents, 126, pf3);
  SET_VECTOR_ELT(contents, 127, ScalarReal(internal->phi));
  SET_VECTOR_ELT(contents, 128, ScalarReal(internal->phi_Val));
  SET_VECTOR_ELT(contents, 129, ScalarReal(internal->Phi2_val));
  SET_VECTOR_ELT(contents, 130, ScalarReal(internal->phiV));
  SEXP pj = PROTECT(allocVector(REALSXP, internal->dim_pj));
  memcpy(REAL(pj), internal->pj, internal->dim_pj * sizeof(double));
  SET_VECTOR_ELT(contents, 131, pj);
  SEXP pj1 = PROTECT(allocVector(REALSXP, internal->dim_pj1));
  memcpy(REAL(pj1), internal->pj1, internal->dim_pj1 * sizeof(double));
  SET_VECTOR_ELT(contents, 132, pj1);
  SEXP pj2 = PROTECT(allocVector(REALSXP, internal->dim_pj2));
  memcpy(REAL(pj2), internal->pj2, internal->dim_pj2 * sizeof(double));
  SET_VECTOR_ELT(contents, 133, pj2);
  SEXP pj3 = PROTECT(allocVector(REALSXP, internal->dim_pj3));
  memcpy(REAL(pj3), internal->pj3, internal->dim_pj3 * sizeof(double));
  SET_VECTOR_ELT(contents, 134, pj3);
  SEXP pm = PROTECT(allocVector(REALSXP, internal->dim_pm));
  memcpy(REAL(pm), internal->pm, internal->dim_pm * sizeof(double));
  SET_VECTOR_ELT(contents, 135, pm);
  SEXP pm1 = PROTECT(allocVector(REALSXP, internal->dim_pm1));
  memcpy(REAL(pm1), internal->pm1, internal->dim_pm1 * sizeof(double));
  SET_VECTOR_ELT(contents, 136, pm1);
  SEXP pm2 = PROTECT(allocVector(REALSXP, internal->dim_pm2));
  memcpy(REAL(pm2), internal->pm2, internal->dim_pm2 * sizeof(double));
  SET_VECTOR_ELT(contents, 137, pm2);
  SEXP pm3 = PROTECT(allocVector(REALSXP, internal->dim_pm3));
  memcpy(REAL(pm3), internal->pm3, internal->dim_pm3 * sizeof(double));
  SET_VECTOR_ELT(contents, 138, pm3);
  SET_VECTOR_ELT(contents, 139, ScalarReal(internal->R0_Val));
  SET_VECTOR_ELT(contents, 140, ScalarReal(internal->Rf_ini));
  SET_VECTOR_ELT(contents, 141, ScalarReal(internal->rho));
  SET_VECTOR_ELT(contents, 142, ScalarReal(internal->rho_Val));
  SET_VECTOR_ELT(contents, 143, ScalarReal(internal->Rj_ini));
  SET_VECTOR_ELT(contents, 144, ScalarReal(internal->Rm_ini));
  SET_VECTOR_ELT(contents, 145, ScalarReal(internal->Rn_ini));
  SET_VECTOR_ELT(contents, 146, ScalarReal(internal->s));
  SET_VECTOR_ELT(contents, 147, ScalarReal(internal->s_Val));
  SET_VECTOR_ELT(contents, 148, ScalarReal(internal->S2_val));
  SET_VECTOR_ELT(contents, 149, ScalarReal(internal->Sf_ini));
  SET_VECTOR_ELT(contents, 150, ScalarReal(internal->sigma_1));
  SET_VECTOR_ELT(contents, 151, ScalarReal(internal->sigma_2));
  SET_VECTOR_ELT(contents, 152, ScalarReal(internal->sigma_2_Val));
  SET_VECTOR_ELT(contents, 153, ScalarReal(internal->sigmaVer));
  SET_VECTOR_ELT(contents, 154, ScalarReal(internal->Sj_ini));
  SET_VECTOR_ELT(contents, 155, ScalarReal(internal->Sm_ini));
  SET_VECTOR_ELT(contents, 156, ScalarReal(internal->Sn_ini));
  SET_VECTOR_ELT(contents, 157, ScalarReal(internal->sV));
  SET_VECTOR_ELT(contents, 158, ScalarReal(internal->timeOscIni));
  SET_VECTOR_ELT(contents, 159, ScalarReal(internal->zeta_s));
  SEXP nms = PROTECT(allocVector(STRSXP, 160));
  ...
  SET_STRING_ELT(nms, 83, mkChar("initial_L_I_out"));
  SET_STRING_ELT(nms, 84, mkChar("initial_Ma"));
  SET_STRING_ELT(nms, 85, mkChar("initial_R0_out"));
  SET_STRING_ELT(nms, 86, mkChar("initial_Rf"));
  SET_STRING_ELT(nms, 87, mkChar("initial_Rj"));
  SET_STRING_ELT(nms, 88, mkChar("initial_Rm"));
  SET_STRING_ELT(nms, 89, mkChar("initial_Rn"));
  SET_STRING_ELT(nms, 90, mkChar("initial_S_I_out"));
  SET_STRING_ELT(nms, 91, mkChar("initial_Sf"));
  SET_STRING_ELT(nms, 92, mkChar("initial_Sj"));
  SET_STRING_ELT(nms, 93, mkChar("initial_Sm"));
  SET_STRING_ELT(nms, 94, mkChar("initial_Sn"));
  SET_STRING_ELT(nms, 95, mkChar("initial_timeOsc"));
  SET_STRING_ELT(nms, 96, mkChar("kappa"));
  SET_STRING_ELT(nms, 97, mkChar("kappa_Val"));
  SET_STRING_ELT(nms, 98, mkChar("m"));
  SET_STRING_ELT(nms, 99, mkChar("m_Val"));
  SET_STRING_ELT(nms, 100, mkChar("Ma_ini"));
  SET_STRING_ELT(nms, 101, mkChar("mj"));
  SET_STRING_ELT(nms, 102, mkChar("mj_Val"));
  SET_STRING_ELT(nms, 103, mkChar("mu"));
  SET_STRING_ELT(nms, 104, mkChar("mu_Val"));
  SET_STRING_ELT(nms, 105, mkChar("n_Sf_Ef"));
  SET_STRING_ELT(nms, 106, mkChar("n_Sj_Ej"));
  SET_STRING_ELT(nms, 107, mkChar("n_Sm_Em"));
  SET_STRING_ELT(nms, 108, mkChar("n_Sn_En"));
  SET_STRING_ELT(nms, 109, mkChar("omega_2_Val"));
  SET_STRING_ELT(nms, 110, mkChar("omega_m"));
  SET_STRING_ELT(nms, 111, mkChar("omega_m_Val"));
  SET_STRING_ELT(nms, 112, mkChar("p"));
  SET_STRING_ELT(nms, 113, mkChar("P_E_R"));
  SET_STRING_ELT(nms, 114, mkChar("P_E_S"));
  SET_STRING_ELT(nms, 115, mkChar("P_I_E"));
  SET_STRING_ELT(nms, 116, mkChar("P_I_S"));
  SET_STRING_ELT(nms, 117, mkChar("P_J_A"));
  SET_STRING_ELT(nms, 118, mkChar("P_matWane"));
  SET_STRING_ELT(nms, 119, mkChar("p1"));
  SET_STRING_ELT(nms, 120, mkChar("p2"));
  SET_STRING_ELT(nms, 121, mkChar("p3"));
  SET_STRING_ELT(nms, 122, mkChar("p4"));
  SET_STRING_ELT(nms, 123, mkChar("pf"));
  SET_STRING_ELT(nms, 124, mkChar("pf1"));
  SET_STRING_ELT(nms, 125, mkChar("pf2"));
  SET_STRING_ELT(nms, 126, mkChar("pf3"));
  SET_STRING_ELT(nms, 127, mkChar("phi"));
  SET_STRING_ELT(nms, 128, mkChar("phi_Val"));
  SET_STRING_ELT(nms, 129, mkChar("Phi2_val"));
  SET_STRING_ELT(nms, 130, mkChar("phiV"));
  SET_STRING_ELT(nms, 131, mkChar("pj"));
  SET_STRING_ELT(nms, 132, mkChar("pj1"));
  SET_STRING_ELT(nms, 133, mkChar("pj2"));
  SET_STRING_ELT(nms, 134, mkChar("pj3"));
  SET_STRING_ELT(nms, 135, mkChar("pm"));
  SET_STRING_ELT(nms, 136, mkChar("pm1"));
  SET_STRING_ELT(nms, 137, mkChar("pm2"));
  SET_STRING_ELT(nms, 138, mkChar("pm3"));
  SET_STRING_ELT(nms, 139, mkChar("R0_Val"));
  SET_STRING_ELT(nms, 140, mkChar("Rf_ini"));
  SET_STRING_ELT(nms, 141, mkChar("rho"));
  SET_STRING_ELT(nms, 142, mkChar("rho_Val"));
  SET_STRING_ELT(nms, 143, mkChar("Rj_ini"));
  SET_STRING_ELT(nms, 144, mkChar("Rm_ini"));
  SET_STRING_ELT(nms, 145, mkChar("Rn_ini"));
  SET_STRING_ELT(nms, 146, mkChar("s"));
  SET_STRING_ELT(nms, 147, mkChar("s_Val"));
  SET_STRING_ELT(nms, 148, mkChar("S2_val"));
  SET_STRING_ELT(nms, 149, mkChar("Sf_ini"));
  SET_STRING_ELT(nms, 150, mkChar("sigma_1"));
  SET_STRING_ELT(nms, 151, mkChar("sigma_2"));
  SET_STRING_ELT(nms, 152, mkChar("sigma_2_Val"));
  SET_STRING_ELT(nms, 153, mkChar("sigmaVer"));
  SET_STRING_ELT(nms, 154, mkChar("Sj_ini"));
  SET_STRING_ELT(nms, 155, mkChar("Sm_ini"));
  SET_STRING_ELT(nms, 156, mkChar("Sn_ini"));
  SET_STRING_ELT(nms, 157, mkChar("sV"));
  SET_STRING_ELT(nms, 158, mkChar("timeOscIni"));
  SET_STRING_ELT(nms, 159, mkChar("zeta_s"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(36);
  return contents;
}
...
void stochSEIR_rhs(stochSEIR_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  state_next[19] = n_En_In + n_Ej_Ij + n_Ef_If + n_Em_Im;
  ...
  state_next[20] = n_Sn_In + n_Sj_Ij + n_Sf_If + n_Sm_Im;
...
void stochSEIRadInf_rhs(stochSEIRadInf_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  state_next[14] = ((Rf - sumBrf + fround(n_Rj_RmRf / (double) 2, 0) + n_Ef_Rf + n_If_Rf) <= 0 ? 1 : (Rf - sumBrf + fround(n_Rj_RmRf / (double) 2, 0) + n_Ef_Rf + n_If_Rf));
  state_next[12] = ((Rj - sumBrj + n_Rn_Rj + n_Ej_Rj) <= 0 ? 1 : (Rj - sumBrj + n_Rn_Rj + n_Ej_Rj));
  state_next[13] = ((Rm - sumBrm + fround(n_Rj_RmRf / (double) 2, 0) + n_Em_Rm + n_Im_Rm) <= 0 ? 1 : (Rm - sumBrm + fround(n_Rj_RmRf / (double) 2, 0) + n_Em_Rm + n_Im_Rm));
  ...
  state_next[8] = ((Ef - sumBef + fround(n_Ej_EmEf / (double) 2, 0) + n_Sf_Ef + n_If_Ef) <= 0 ? 1 : (Ef - sumBef + fround(n_Ej_EmEf / (double) 2, 0) + n_Sf_Ef + n_If_Ef));
  state_next[6] = ((Ej - sumBej + n_En_Ej + n_Sj_Ej) <= 0 ? 1 : (Ej - sumBej + n_En_Ej + n_Sj_Ej));
  state_next[7] = ((Em - sumBem + fround(n_Ej_EmEf / (double) 2, 0) + n_Sm_Em + n_Im_Em) <= 0 ? 1 : (Em - sumBem + fround(n_Ej_EmEf / (double) 2, 0) + n_Sm_Em + n_Im_Em));
  ...
  state_next[3] = ((Sf - sumBsf + fround(n_Sj_SmSf / (double) 2, 0) + n_Ef_Sf + n_If_Sf + n_Rf_Sf) <= 0 ? 1 : (Sf - sumBsf + fround(n_Sj_SmSf / (double) 2, 0) + n_Ef_Sf + n_If_Sf + n_Rf_Sf));
  state_next[1] = ((Sj - sumBsj + n_Sn_Sj + n_Ma_Sj + n_Ej_Sj + n_Rj_Sj) <= 0 ? 1 : (Sj - sumBsj + n_Sn_Sj + n_Ma_Sj + n_Ej_Sj + n_Rj_Sj));
  state_next[2] = ((Sm - sumBsm + fround(n_Sj_SmSf / (double) 2, 0) + n_Em_Sm + n_Im_Sm + n_Rm_Sm) <= 0 ? 1 : (Sm - sumBsm + fround(n_Sj_SmSf / (double) 2, 0) + n_Em_Sm + n_Im_Sm + n_Rm_Sm));
