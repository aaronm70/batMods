...
detSEIR <- function (betaFX = NULL, betaFXVal = NULL, betaVer = NULL, birthType = NULL,
    c_Val = NULL, c_val2 = NULL, dt = NULL, Ef_ini = NULL, Ej_ini = NULL,
    Em_ini = NULL, En_ini = NULL, envOscType = NULL, epsilon_Val = NULL,
    gamma_1_Val = NULL, gamma_2_Val = NULL, gammaVer = NULL,
    If_ini = NULL, Ij_ini = NULL, Im_ini = NULL, In_ini = NULL,
    kappa_Val = NULL, m_Val = NULL, Ma_ini = NULL, mj_Val = NULL,
    mu_Val = NULL, omega_2_Val = NULL, omega_m_Val = NULL, phi_Val = NULL,
    Phi2_val = NULL, R0_Val = NULL, Rf_ini = NULL, rho_Val = NULL,
    Rj_ini = NULL, Rm_ini = NULL, Rn_ini = NULL, s_Val = NULL,
    S2_val = NULL, Sf_ini = NULL, sigma_2_Val = NULL, sigmaVer = NULL,
    Sj_ini = NULL, Sm_ini = NULL, Sn_ini = NULL, timeOscIni = NULL,
    zeta_s = NULL, user = list(betaFX = betaFX, betaFXVal = betaFXVal,
        betaVer = betaVer, birthType = birthType, c_Val = c_Val,
        c_val2 = c_val2, dt = dt, Ef_ini = Ef_ini, Ej_ini = Ej_ini,
        Em_ini = Em_ini, En_ini = En_ini, envOscType = envOscType,
...
stochSEIR <- function (betaFX = NULL, betaFXVal = NULL, betaVer = NULL, birthType = NULL,
    c_Val = NULL, c_val2 = NULL, dt = NULL, Ef_ini = NULL, Ej_ini = NULL,
    Em_ini = NULL, En_ini = NULL, envOscType = NULL, epsilon_Val = NULL,
    gamma_1_Val = NULL, gamma_2_Val = NULL, gammaVer = NULL,
    If_ini = NULL, Ij_ini = NULL, Im_ini = NULL, In_ini = NULL,
...
stochSEIRadInf <- function (betaVer = NULL, c_Val = NULL, dt = NULL, Ef_ini = NULL,
    Ej_ini = NULL, Em_ini = NULL, En_ini = NULL, epsilon_Val = NULL,
    gamma_1_Val = NULL, gamma_2_Val = NULL, gammaVer = NULL,
    If_ini = NULL, Im_ini = NULL, kappa_Val = NULL, m_Val = NULL,
    Ma_ini = NULL, mj_Val = NULL, mu_Val = NULL, omega_2_Val = NULL,
    omega_m_Val = NULL, phi_Val = NULL, R0_Val = NULL, Rf_ini = NULL,
    rho_Val = NULL, Rj_ini = NULL, Rm_ini = NULL, Rn_ini = NULL,
    s_Val = NULL, Sf_ini = NULL, sigma_1_Val = NULL, sigma_2_Val = NULL,
    sigmaVer = NULL, Sj_ini = NULL, Sm_ini = NULL, Sn_ini = NULL,
    user = list(betaVer = betaVer, c_Val = c_Val, dt = dt, Ef_ini = Ef_ini,
        Ej_ini = Ej_ini, Em_ini = Em_ini, En_ini = En_ini, epsilon_Val = epsilon_Val,
        gamma_1_Val = gamma_1_Val, gamma_2_Val = gamma_2_Val,
        gammaVer = gammaVer, If_ini = If_ini, Im_ini = Im_ini,
        kappa_Val = kappa_Val, m_Val = m_Val, Ma_ini = Ma_ini,
        mj_Val = mj_Val, mu_Val = mu_Val, omega_2_Val = omega_2_Val,
